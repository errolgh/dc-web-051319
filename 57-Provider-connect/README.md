...
### Goal: we want to NOT use this.forcedUpdate
 - we have to change props to get components to re-render
 - We are going to trick React into think a change in the store is a change in props

For each component that reads form the store, we are going to "inject" some props into that component
